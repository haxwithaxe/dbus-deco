...
class DBusServiceProperty:
    ...
    def __init__(self, fget=None, fset=None, fdel=None, doc=None, diproperty=None):
        self.fget = fget
        self.fset = fset
        self.fdel = fdel
        self.di = diproperty
    ...
    def getter(self, fget):
        self.di.readable = True
        return type(self)(fget, self.fset, self.fdel, self.__doc__, self.di)

    def setter(self, fset):
        self.di.writeable = True
        return type(self)(self.fget, fset, self.fdel, self.__doc__, self.di)
